...
class SignupOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameTextField,fnameTextField,dobTextField,genderTextField,emailTextField,martialTextField,addressTextField,cityTextField,stateTextField,pinCodeTextField,pinTextField;
    JButton next;
    ...
    SignupOne(){
        ...
        ButtonGroup gendergroup = new ButtonGroup(); // to select one from the above we have to group them all.
        ...
        martial.setBounds(100,390,150, 30);
        add(martial);
        ...
        ButtonGroup maritalgroup = new ButtonGroup(); // to select one from the above we have to group them all.
    ...
    public void actionPerformed(ActionEvent ae){
        String formno = ""+random;  // conversion of long to string
        String name = nameTextField.getText();
        String fname = fnameTextField.getText();
        String dob = ((JTextField)dateChooser.getDateEditor().getUiComponent()).getText();  // getui.. returns textField
        ...
        try{
            if(name.equals("")){
                ...
                // if user enter's its data correctly
